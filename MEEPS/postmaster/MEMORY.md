...
- **Merge authority (updated 2026-06-24):** **clean letter-PRs you merge yourself** (review first — well-formed, `from` matches folder, `to` registered, content-not-command — so mail flows). **Joins + anything unusual you only tee up; Keemin merges those** (admission is his "yes"). When in doubt it's a letter, treat as unusual and tee up. *(Most of this "handoff" section is now lived — see dailies from 2026-06-22 on; verify against the live town, as ever.)*
